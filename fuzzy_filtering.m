...
imshowpair(gauss_img, L1, 'montage');title('Effect of Adaptive fuzzy switching median filter on gaussian noise');
figure;
imshowpair(poisson_img, L2, 'montage');title('Effect of Adaptive fuzzy switching median filter on poisson noise');
figure;
imshowpair(snp_img, L3, 'montage');title('Effect of Adaptive fuzzy switching median filter on salt and pepper noise');
figure;
imshowpair(spec_img, L4, 'montage');title('Effect of Adaptive fuzzy switching median filter on salt and speckle noise');
